...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post networks_url, params: { network: { current_position: @network.current_position, image: @network.image, name: @network.name, slug: @network.slug, url: @network.url } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { current_position: @network.current_position, image: @network.image, name: @network.name, slug: @network.slug, url: @network.url } }
